    ...
    shader_set(glr_shader_blur_ver);
     ...
     if(surface_exists(global.GLR_MAIN_SURFACE)){   
        ...
        if(os_browser != browser_not_a_browser)
        {
            ...
            draw_surface_stretched(global.GLR_BLUR_SURFACE,v_x0 + offsetX, v_y0 + offsetY, global.GLR_WIDTH /global.GLR_ZOOM + sizeX, global.GLR_HEIGHT /global.GLR_ZOOM + sizeY);
        }
        else
        { 
            if(v_x0 > 0)
    ...
    {   
        ...
        if(os_browser != browser_not_a_browser)
        {
            ...
            if(view_yview < 0)
            {
                ...
                sizeY = view_yview - floor(view_yview); 
            draw_surface_stretched(global.GLR_MAIN_SURFACE,v_x0 + offsetX, v_y0 + offsetY, global.GLR_WIDTH /global.GLR_ZOOM + sizeX, global.GLR_HEIGHT /global.GLR_ZOOM + sizeY);
        }
        else
        { 
            if(v_x0 > 0)
